...
import type { VenueSearchParams, VenueType, SlotType } from "@/lib/types";

// Demo data for when DB is empty
const demoVenues = [
  {
    id: "1", vendor_id: "v1", name: "Royal Palace Banquet Hall", slug: "royal-palace-banquet",
    description: "An opulent banquet hall with regal architecture", venue_type: "banquet_hall" as const,
  ...
  },
  {
    ...
    description: "Beautiful garden and lawns for outdoor celebrations", venue_type: "resort" as const,
  ...
  },
  {
    ...
    description: "A centuries-old haveli reimagined for grand celebrations", venue_type: "heritage" as const,
  ...
  },
  {
    ...
    description: "A serene lakeside farmhouse setting", venue_type: "farmhouse" as const,
  ...
  },
  {
    ...
    description: "Massive convention center", venue_type: "convention_center" as const,
  ...
  },
  {
    ...
    description: "Scenic lawns in Kaimur hills", venue_type: "lawn" as const,
...
export async function VenueListings() {
  // In production, real data comes from Supabase:
    ...
    <>
      ...
      {displayVenues.length === 0 ? (
        <div className="text-center py-20">
          <p className="text-lg text-gray-500 mb-2">No venues found</p>
